    ...
    <div className="bg-Rich-Black">
      <div className="container max-w-[1152px] mx-auto px-3 lg:py-36 md:py-28 sm:py-20 py-12">
        <div className="flex justify-center">
          <div
            className="max-w-[1043px] px-3 w-full min-h-[341px] flex flex-col justify-center items-center border border-light-gray hover:shadow-[0px_0px_10px_2px_gray] duration-300 rounded-2xl bg-cover bg-[url('/assets/webp/platatorma-bg.webp')]"
            data-aos="flip-right"
